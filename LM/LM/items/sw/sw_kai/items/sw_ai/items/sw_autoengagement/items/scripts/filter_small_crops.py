"""CLI: build the small-crop exclusion list (no files are moved or deleted).
...
def main(data_root: str, out: str = "data/annotations/excluded_crops.json",
         min_px: int = 30, splits: str = "train,val") -> None:
