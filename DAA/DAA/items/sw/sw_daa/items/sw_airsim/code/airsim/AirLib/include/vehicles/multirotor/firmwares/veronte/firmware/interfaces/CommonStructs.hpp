...
{
public:
    AxisN(size_t n) : vals_(n) {

    }
    
    AxisN(const std::vector<T>& values) : vals_(values) {
...
{
public:
    GoalModeN(size_t n, GoalModeType default_mode = GoalModeType::Passthrough) : 
        modes_(n, default_mode) 
    {

    }
    
    GoalModeN(const std::vector<GoalModeType>& mode_values) : 
        modes_(mode_values) 
    {

    }
    
    GoalModeType& operator[](unsigned int index) { 
        return modes_[index]; 
    }

    const GoalModeType& operator[](unsigned int index) const { 
        return modes_[index]; 
    }
    ...
    std::vector<GoalModeType>& values() { 
        return modes_; 
    }

    const std::vector<GoalModeType>& values() const { 
        return modes_; 
    }

private:
    std::vector<GoalModeType> modes_;
};
