...
#ifndef msr_airlib_AirSimVeronteCommLink_hpp
#define msr_airlib_AirSimVeronteCommLink_hpp
...
namespace airlib
{
    ...
    class AirSimVeronteCommLink : public veronte::ICommLink
    {
