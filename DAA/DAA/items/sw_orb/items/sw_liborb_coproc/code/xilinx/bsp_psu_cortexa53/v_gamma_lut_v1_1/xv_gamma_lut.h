...
//----------------------------------------------------------------------
//                         Changelog                                        
// 13/11/2023 - uintptr_t and XV_demosaic_Config definition with linux - Victor Morales for Embention  
// 14/11/2023 - Change register modification functions  - Victor Morales for Embention                                          
//    
//----------------------------------------------------------------------
...
#else
#define XV_gamma_lut_WriteReg(BaseAddress, RegOffset, Data) \
    XV_gamma_lut_Out32(BaseAddress + RegOffset, Data)
#define XV_gamma_lut_ReadReg(BaseAddress, RegOffset) \
    XV_gamma_lut_In32(BaseAddress + RegOffset)
