...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_0_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_HIGH - XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + 1))
        return 0;
    memmap_init(&mm, InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + offset);
    for (i = 0; i < length; i++) {
        memmap_write_byte(mm,(InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_0_BASE + offset + i), *(data + i));
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_1_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    memmap_init(&mm, InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + offset);
    for (i = 0; i < length; i++) {
        memmap_write_byte(mm,(InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_1_BASE + offset + i), *(data + i));
...
u32 XV_gamma_lut_Write_HwReg_gamma_lut_2_Bytes(XV_gamma_lut *InstancePtr, int offset, char *data, int length) {
    ...
    memmap_init(&mm, InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + offset);
    for (i = 0; i < length; i++) {
        memmap_write_byte(mm,(InstancePtr->Config.BaseAddress + XV_GAMMA_LUT_CTRL_ADDR_HWREG_GAMMA_LUT_2_BASE + offset + i), *(data + i));
