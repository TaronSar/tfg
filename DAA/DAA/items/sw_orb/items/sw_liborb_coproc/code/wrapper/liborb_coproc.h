#ifndef __LIBORB_COPROC_H__
#define __LIBORB_COPROC_H__
...
class ORB_coproc
{
	...
	public:
		...
		static void get_frame(void* frame_in);
		...
		static void initialize(uint32_t width, uint32_t height, uint32_t shs, uint16_t gain, bool camera, const std::string& dma_buff);
