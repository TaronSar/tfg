...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0020 0x00717F00 0x00014F00
		# : BY PASS PLL
		# Register : APLL_CTRL @ 0XFD1A0020</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01011E00
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0808050F
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x048C820D
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000A0B
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00001010
...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800A0 0x000000FE 0x00000020
    ...
    mask_write 0XFF1800A4 0x000000FE 0x00000020
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02640
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x033FEF1E
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FD9795
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F667EB
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000840
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000840
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFBF0040
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFFBF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
