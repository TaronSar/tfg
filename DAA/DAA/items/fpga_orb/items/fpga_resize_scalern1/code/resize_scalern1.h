...
#ifndef RESIZE_SCALERN1_H
#define RESIZE_SCALERN1_H
...
void resize_scalern1(ap_uint<32> cfg_width, ap_uint<32> cfg_height, ap_uint<16> cfg_scale, ap_uint<16> cfg_invscale, hls::stream<ap_axiu<INPUT_STREAM_BIT, 1, 1, 1> > &srcStream, hls::stream<ap_axiu<OUTPUT_STREAM_BIT, 1, 1, 1> > &outStream);
