...
int main()
{
    ...
    cfgin.data.range(31, 16) = 0;
    cfgin.keep = 0xF;
    cfgin.last = 0;		//cfgin.last = 1;
    cfgStream.write(cfgin);
    // **** SC: included THRESHOLD parameter
    cfgin.data = TH;
    cfgin.keep = 0xF;
    cfgin.last = 1;
    cfgStream.write(cfgin);
    ...
    // SC verifico el último last. Realizar cosimulación
    cout << cnt << " ";
                 cout << endl;
    cout << outData.last << " ";
             cout << endl;
