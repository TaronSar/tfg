...
/************ SC: process_cfg amended for new THRESHOLD parameter **************************
*
*  Data sent through the cfgStream (they must be read in the following order):
*  - with
*  - height
*  - scale
*  - inv_scale
*  - threshold
*  Data to be sent by Resize in the following order:
*  - threshold
*  - new_width
*  - new_height / last
*
