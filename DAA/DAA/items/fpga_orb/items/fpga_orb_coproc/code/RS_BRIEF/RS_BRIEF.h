...
#ifndef RS_BRIEF640_H_
#define RS_BRIEF640_H_
...
#define MERGE_NUM 4
#define WIDTH_AFTER_MERGE 162//319 // ceil((WIDTH + WIN_SZ - 1) / MERGE_NUM)
...
void RS_BRIEF640(hls::stream<ap_axiu<32, 1, 1, 1> > &cfgStream, hls::stream<ap_axiu<INPUT_STREAM_BIT, 1, 1, 1> > &srcPixelStream, hls::stream<ap_axiu<INPUT_STREAM_BIT, 1, 1, 1> > &srcFASTStream, hls::stream<ap_axiu<512, 1, 1, 1> > &outStream);
